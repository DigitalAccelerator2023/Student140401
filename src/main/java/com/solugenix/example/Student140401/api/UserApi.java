...
public interface UserApi {
    ...
    @ApiOperation(value = "", nickname = "getUsers", notes = "", response = User.class, responseContainer = "List", tags={  })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "Get user list", response = User.class, responseContainer = "List") })
